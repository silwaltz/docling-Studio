...
log "Done."
log ""
log "Prerequisites are in place. Next steps are documented in Section 6 of"
log "  docs/operations/vllm-rhel-installation.md"
log "(Stack bring-up). The short version:"
log ""
...
log "  5. cd /root/vllm-rhel-install && sudo ./verify-vllm-rhel.sh"
...
log "  - If you skipped this script (prereqs already in place), start at"
log "    Section 6.1 instead."